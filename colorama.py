...
#sets up the window
window = Tk()
window.title("Colorama")
window.geometry("500x500+650+300")
...
#define buttons
backButton = Button(window, command=titleScreen, bg='AntiqueWhite1', bd='5', activebackground='light salmon', font=("Terminal", 10), text='Back', width=25, height=2, relief=RIDGE)    
startButton = Button(window, command=game, bg='AntiqueWhite1', bd='5', activebackground='light salmon', font=("Terminal", 10), text='Play', width=25, height=2, relief=RIDGE)
howButton = Button(window, command=howToPlay, bg='AntiqueWhite1', bd='5', activebackground='light salmon', font=("Terminal", 10), text='How To Play', width=25, height=2, relief=RIDGE)
